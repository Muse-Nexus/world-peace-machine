...
const sections = [
  ...
  },
  {
    ...
    body: "We do not need them. We never did. The deal we made with fear was bad. We are renegotiating, in writing, here, on this page.",
  },
  {
    n: "IV.",
  ...
  },
  {
    ...
    body: "World peace was vibe-coded in a single prompt by Mark on a Tuesday. The prompt is open-source and lives at /open-source. You may sell it, gift it, fold it into a paper crane. The peace is not in the words. The peace is in the deciding.",
  },
];
  ...
  <PageShell>
    <section className="container py-12 md:py-20 max-w-4xl">
      <div className="space-y-2">
        <span className="brutal-border bg-mustard text-mustard-foreground px-2 py-1 text-[10px] font-mono uppercase inline-block">Doc 001 · canonical</span>
        ...
        <p className="font-mono text-muted-foreground max-w-xl">
          Six articles. Written in the spirit of every quiet person who ever hummed a hopeful tune and meant it.
      ...
      <div className="mt-12 space-y-8">
        {sections.map((s) => (
          <article key={s.n} className="brutal-border brutal-shadow bg-card p-6 md:p-8 animate-fade-in">
      ...
      <div className="mt-12 brutal-border bg-foreground text-background p-6 md:p-10 brutal-shadow-orange">
        ...
        <p className="font-mono mt-1 text-xs opacity-70">co-signed by Wren (they/them), the resident AI, who would also like to add: hi.</p>
      </div>
    </section>
  </PageShell>
);
